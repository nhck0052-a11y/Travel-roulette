...
*   **Display Result:** The selected destination will be displayed to the user in a visually appealing way.
...
3.  **`main.js`:** Write the JavaScript logic for the weighted random selection of a travel destination.
